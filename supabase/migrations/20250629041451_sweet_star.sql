/*
  # Fix Profile Creation and Handle Missing Profiles

  1. Database Changes
    - Fix the handle_new_user function to properly create profiles
    - Add a policy to allow profile insertion during user creation
    - Create missing profiles for existing users

  2. Security
    - Ensure RLS policies allow profile creation during registration
    - Maintain security for profile access
*/
...
BEGIN
  ...
  VALUES 
    ('Free Plan', 'Basic resume analysis and templates', 0, 
     ARRAY['1 Resume Template', '5 AI Analyses per month', 'Basic Support', 'PDF Download'], 
     1, 5),
    ('Premium Plan', 'Unlimited access to all features', 19.99, 
     ARRAY['All Resume Templates', 'Unlimited AI Analyses', 'Priority Support', 'PDF & DOCX Downloads', 'Advanced AI Features', 'ATS Score Analysis'], 
     -1, -1)
